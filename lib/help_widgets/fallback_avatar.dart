...
import 'package:flutterappsampletask/help_widgets/image_picker_state.dart';
  ...
  Widget _fallBackAvatar() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: widget.circleBorder ?? Colors.black,
          width: widget.circleWidth ?? 1,
        ),
        ...
        child: ClipPath(
          ...
          child: Container(
              decoration: BoxDecoration(
                ...
                shape: BoxShape.circle,
                border: Border.all(
                  color: widget.circleBorder ?? Colors.black54,
                  width: 1,
                ),
              ),
